...
- A per-verse alternate translation dropdown populated from the English versions licensed to the YouVersion app, plus Greek LXX and Hebrew MT lexical anchors.
...
The KJV is the base text for the prototype. The English dropdown is populated dynamically from the versions licensed to the YouVersion app; the Hebrew and Greek controls are compact lexical anchors for study, not a substitute for a critical edition or full morphological parsing.
